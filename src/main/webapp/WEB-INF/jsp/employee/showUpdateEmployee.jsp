		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr><td class="font3 fftd">
		    	<table>
		    		...
		    		<tr>
		    			<td class="font3 fftd">手机：<input name="phoneNumber" id="phone" size="20" value="${employee.phoneNumber }"/></td>
		    			<td class="font3 fftd">电&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;话：<input name="telNumber" id="tel" size="20" value="${employee.telNumber }"/></td>
		    		</tr>
			...
			<tr>
				<td class="font3 fftd">
					...
					QQ&nbsp;&nbsp;号码：<input name="qq" id="qqNum" size="20" value="${employee.qq }"/>
				</td>
			</tr>
			<tr><td class="main_tdbor"></td></tr>
